...
// printShaderError
// Display useful error messages if shader fails to compile or link
...
void setLightPos(const GLuint program, const GLfloat *lightPos, GLuint lightInteger) {
	...
	// new
	string integer = std::to_string(lightInteger);
	int uniformIndex = glGetUniformLocation(program, ("lightPosition[" + integer + "]").c_str());
	glUniform4fv(uniformIndex, 1, lightPos);
}
...
void setLight(const GLuint program, const lightStruct light, GLuint lightInteger) {
	...
	// new and updated for this program

	string integer = std::to_string(lightInteger);
	int uniformIndex = glGetUniformLocation(program, ("light[" + integer + "].ambient").c_str());
	cout << "Amb" << lightInteger << ": " << uniformIndex << endl;
	glUniform4fv(uniformIndex, 1, light.ambient);
	uniformIndex = glGetUniformLocation(program, ("light[" + integer + "].diffuse").c_str());
	glUniform4fv(uniformIndex, 1, light.diffuse);
	cout << "Diffuse" << lightInteger << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("light[" + integer + "].specular").c_str());
	glUniform4fv(uniformIndex, 1, light.specular);
	cout << "Spec" << lightInteger << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("lightPosition[" + integer + "]").c_str());
	glUniform4fv(uniformIndex, 1, light.position);
	cout << "Position" << lightInteger << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("light[" + integer + "].attConst").c_str());
	glUniform1f(uniformIndex, light.attConst);
	cout << "Constant" << lightInteger << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("light[" + integer + "].attLinear").c_str());
	glUniform1f(uniformIndex, light.attLinear);
	cout << "Linear" << lightInteger << ": " << uniformIndex << endl;
	uniformIndex = glGetUniformLocation(program, ("light[" + integer + "].attQuadratic").c_str());
	glUniform1f(uniformIndex, light.attQuadratic);
	cout << "Quadratic" << lightInteger << ": " << uniformIndex << endl;
